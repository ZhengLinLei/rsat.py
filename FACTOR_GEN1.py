...
from lib import consts as constants
from lib import utils
from lib import primes as primeSieve
from tool.pollard import rhox as pollardRho
from tool.ecm import ecm
...
if __name__ == "__main__":
    ...
    print("\n ==== Trying with RHO and ECM stages ==== \n\n")
    t = time.time()
